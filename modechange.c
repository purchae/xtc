/* This file is from GNU fileutils 3.16. It is used for XTC's chmod command. */
...
/* Modified by Peter Kelly <peter@area51.org.au>, Apr 10 1999 to fix
 	warnings given by gcc -Wall:
 	- forced inclusion of stdlib.h (line 42)
 	- gave change an initial value of NULL in mode_compile (line 83)
 	*/
 		...
 		unsigned masked_ops;
{
	...
	struct mode_change *change = NULL;	/* An element of the linked list. */
